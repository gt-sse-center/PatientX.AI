...
def main(
        ...
        nr_representative_docs: Annotated[int, typer.Option(help="Number of representative docs to save in intermediate Bertopic results")] = 10,
        low_memory: Annotated[bool, typer.Option()] = False,
        nr_docs: Annotated[int, typer.Option(help="Number of representative docs to pass to representation model")] = 10,
